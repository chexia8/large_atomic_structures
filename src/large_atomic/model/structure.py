...
class Structure:
    def __init__(self, xyz_file, hamiltonian_file, overlap_file, pbc, orbital_basis, dataset='custom', database_props=None, self_interaction=True, bothways=False, make_soap=False, save_matrices=False, rcut=4.0, cell = None, use_overlap=False):
        ...
        if dataset == 'schnet':
            ...
            # initialize atomic structure
            self.init_atomic_structure(self.xyz_file, pbc, self_interaction, bothways, cell)
                ...
                for alpha in range(num_orbitals_i):
                    for beta in range(num_orbitals_j):
                        ...
                        if operator == 'hamiltonian':
                            ...
                            if(starting_i+alpha,starting_j+beta) in self.overlap:
                                mat[alpha,beta] = self.overlap[(starting_i+alpha,starting_j+beta)]
